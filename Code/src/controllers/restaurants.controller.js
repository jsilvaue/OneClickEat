...
exports.create = async function (req, res) {
    const new_restaurant = new Restaurants(req.body);
    try {
        let response = await Restaurants.create(new_restaurant);
...
exports.findById = async function (req, res) {
    try {
        let response = await Restaurants.findById(req.params.id);
...
exports.update = async function (req, res) {
    try {
        ...
        let response = await Restaurants.update(req.params.id, new Restaurants(req.body));
